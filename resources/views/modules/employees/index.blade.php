        ...
        <div class="modal-content">
            ...
            <form id="employeeForm">
                <div class="form-group">
                    ...
                    <input type="text" id="dni" name="id_number" required>
                </div>
                <div class="form-row">
                    <input type="text" id="nombre" name="first_name" placeholder="Nombre" required>
                    <input type="text" id="apellido" name="last_name" placeholder="Apellido" required>
                </div>
                <div class="form-group">
                    <label>Email:</label>
...
@push('scripts')
    <script type="module" src="{{ asset('js/modules/employees.js') }}"></script>
    <script>
